...
from .models import Capas, crear_modelo, Atributos, Categoria
from rest_framework.decorators import list_route
from rest_framework.response import Response
from django.contrib.gis.db import models
from .serializers import CapaSerializador, CapaListSerializador, CategoriasListSerializador,\
                         CategoriasSerializador
import pygeoj
...
class CategoriaRecursos(viewsets.ModelViewSet):
    ...
    serializer_class = CategoriasSerializador


    def get_serializer_class(self):
        if self.action in ['list', "retrieve"]:
            return CategoriasListSerializador
        return CategoriasSerializador
